...
\
Meeting with engineer, they think that we are a likely candidate.\
3 years to see if it’s viable to broadcast, if we are granted.\
Point system, we score approx 5 points out of 6.\
Tie breaker if more than one applies for frequency.\
\
Free to apply, would need to pay engineer and lawyer.\
\
Only open air right now is south west corner of SF.\
Possibly partnership with SF state, repeater on campus?\
Use a cell phone tower as a repeater?\
Question: is this compelling enough to do through the process?\
Web stream separate from signal.
...
Engineer is $600. He handles application. $2300 total. If we are accepted, then lawyer, $1000-$1500 $4000 to even think about starting to buy equipment.\
\
Structural concerns? Wind?\
\
In general, started BFF to be drama adverse. If we went down another path that went that way, we would stop and proceed.
...
Studio needs to be within 10 miles.\
\
Both streams can live online.
...
FCC paperwork and filing.\
\
Things that would need more people: development, programing, GM and Exec Dir. Things that the station would already need.
