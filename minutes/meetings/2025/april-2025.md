...
1. Board Term Renewal: Amanda Guest
2. Trademark point of contact
3. Shifting to governance from working board
   1. Create infrastructure so that this board can provide strategic guidance to steer operations
   2. Draft additional policies to guide day-to-day operations
4. Deleting the BFF.fm Facebook page
5. Mosswood Meltdown
6. Volunteer month celebration
...
* \[Clair] Contact Alan, ask about payment method, share [board@bff.fm](mailto:board@bff.fm) contact, please reach out to us before taking any add’l action ✅
* \[Irving] Look into setting up a BFF.fm [Venmo Charity](https://help.venmo.com/hc/en-us/articles/6678084998291-Charity-Profile-FAQ) account
