---
description: August 12, 2025, San Francisco
---
...
5. Other business
   1. Update from Mark on [BFF.fm](http://bff.fm) trademark
...
{% hint style="success" %}
ALL in favor to vote for voting for Irving
{% endhint %}

{% hint style="success" %}
ALL voted YES to renew Irving for a second term on the Board as Treasurer.
{% endhint %}
...
{% hint style="warning" %}
Check back in a month for a vote on this - table for now.
{% endhint %}
